# create a variable called answer, which contains a list with all the numbers divisible by 12, for numbers between 1 and 100 (inclusive)
answer = [val for val in range(1,101) if val % 12 == 0]
print(answer) 


#list comprehension  - given 2 lists, create a variable which is a new list that is the intersection fo the two
